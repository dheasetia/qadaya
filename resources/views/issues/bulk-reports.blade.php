                ...
                <div class="widget-content widget-content-area text-center split-buttons">
                    ...
                    @else
                        @if(count($files) === 0)
                            <div class="row">
                                <div class="d-grid gap-2">
                                    <button id="btn-generate-pdf" onclick="generatePDF()" class="btn btn-danger btn-lg mb-2 me-4">
                            ...
                            <div class="row">
                                @foreach($files as $file)
                                    <div class="col-3 d-grid gap-2">
                                        <a href="{{asset('storage') . '/' .$file}}" class="btn btn-success mb-2 me-4" download>{{substr(Str::title(str_replace('-', ' ', $file)), 0, strlen($file) - 4)}}</a>
                                    </div>
                                @endforeach
                            </div>
                            <button id="btn-regenerate-pdf" onclick="regeneratePDF()" class="btn btn-danger btn-lg mb-2 me-4">
