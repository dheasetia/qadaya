    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">قائمة القضايا</li>
            </ol>
        </nav>
    </div>
    ...
    <script>
        $('#zero-config').DataTable({
            ...
            "oLanguage": {
                ...
                "emptyTable": "البيانات فارغة، يمكنك استيراد ملف أكسل بانقر على قائمة استيراد ملف أكسل في القائمة الجانبية"
            },
            "stripeClasses": [],
